...
const SvgDoc = () => (
  <svg data-name="Layer 1" viewBox="0 0 505.24 465.77">
    <defs>
      <linearGradient
        id="b"
        x1={156.18}
      ...
      <linearGradient id="d" x1={380.66} y1={248.08} x2={512.61} y2={144.54} xlinkHref="#a" />
      <linearGradient id="e" x1={355.61} y1={323.24} x2={597.1} y2={192.55} xlinkHref="#a" />
      <linearGradient id="f" x1={219.88} y1={345.29} x2={123.28} y2={464.62} xlinkHref="#b" />
      <linearGradient id="g" x1={192.64} y1={133.46} x2={351.74} y2={133.46} xlinkHref="#b" />
      <linearGradient id="h" x1={192.64} y1={150.51} x2={351.74} y2={150.51} xlinkHref="#b" />
      <linearGradient id="i" x1={192.64} y1={167.56} x2={351.74} y2={167.56} xlinkHref="#b" />
      <linearGradient id="j" x1={192.64} y1={184.6} x2={351.74} y2={184.6} xlinkHref="#b" />
      <linearGradient id="k" x1={192.64} y1={201.65} x2={351.74} y2={201.65} xlinkHref="#b" />
      <linearGradient id="l" x1={219.05} y1={56.91} x2={318.96} y2={65.91} xlinkHref="#a" />
      <linearGradient
        id="c"
        x1={293.8}
        y1={9.07}
      ...
      <linearGradient id="m" x1={130.78} y1={197.17} x2={361.95} y2={298.3} xlinkHref="#b" />
      <linearGradient id="n" x1={435.9} y1={278.67} x2={315.86} y2={300.49} xlinkHref="#a" />
      <linearGradient id="o" x1={409.57} y1={238.79} x2={391.28} y2={259.6} xlinkHref="#c" />
    </defs>
    <path
    ...
    <path
      ...
      fill="url(#b)"
    />
    <path fill="url(#a)" d="M157.29 65.28H372.58V387.9H157.29z" />
    <path
    ...
    <path
      ...
      fill="url(#f)"
    />
    <rect x={192.64} y={130.62} width={159.1} height={5.68} rx={2.84} fill="url(#g)" />
    <rect x={192.64} y={147.67} width={159.1} height={5.68} rx={2.84} fill="url(#h)" />
    <rect x={192.64} y={164.71} width={159.1} height={5.68} rx={2.84} fill="url(#i)" />
    <rect x={192.64} y={181.76} width={159.1} height={5.68} rx={2.84} fill="url(#j)" />
    <rect x={192.64} y={198.81} width={159.1} height={5.68} rx={2.84} fill="url(#k)" />
    <path
